...
Another available option, that has been provided by Prof. Dr. Barthel, was the Fotolia and Pixabay image datasets, which can be explored on the picsbuffet website \cite{noauthor_picsbuffet_nodate}. However, in addition to the problem with too much variety as in DeepFashion, the attributes saved for each item did not prove to be useful and the images did not have sufficient resolution. 
