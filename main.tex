...
\begin{multicols}{3}
\begin{figure*}[ht!]
\fbox{\includegraphics[width=.3\textwidth]{fotolia_ex1}}\hfill
\fbox{\includegraphics[width=.3\textwidth]{fotolia_ex2}}\hfill
\fbox{\includegraphics[width=.3\textwidth]{fotolia_ex3}}
\label{fig:fotolia}
\end{figure*}
\end{multicols}

Unfortunately, additionally to a low resolution of the returned images - around 100 x 160 pixels - the returned results also has too much variety, such as different model poses, different zoom levels and backgrounds. The description of the images did not include many useful attributes, with most pictures having tags such as: beauty, young, person, female, hair etc.
