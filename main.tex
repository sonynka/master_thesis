...
\begin{figure}[h]
\centering
\subcaptionbox{blouse}{\includegraphics[width=0.2\linewidth]{dataset_examples/blouse}}
\subcaptionbox{skirt}{\includegraphics[width=0.2\linewidth]{dataset_examples/skirt}}
\subcaptionbox{jacket}{\includegraphics[width=0.2\linewidth]{dataset_examples/jacket}} \\
\subcaptionbox{knitwear}{\includegraphics[width=0.2\linewidth]{dataset_examples/knitwear}}
\subcaptionbox{pants}{\includegraphics[width=0.2\linewidth]{dataset_examples/pants}}
\subcaptionbox{dress}{\includegraphics[width=0.2\linewidth]{dataset_examples/dress}}
\caption{\label{fig:dataset} \textbf{Examples of images in the final dataset with their respective categories.}}
\end{figure}
...
For some of the tasks of this project, not only product images, but also images of people modeling the clothes were required. I have acquired this auxiliary dataset by downloading the model images for all products. However, each product, has multiple images of a model wearing it, and for the purposes of this project, I had to use clustering methods to filter out only images where the models are facing the front and photographed full-bodied.
