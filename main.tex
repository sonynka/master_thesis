...
\begin{figure}[h]
\centering
\subcaptionbox{Cycle GAN Model}
{\includegraphics[height=3cm]{CycleGAN_graph}}\hspace{1cm}
\subcaptionbox{Cycle Consistency Loss}
{\includegraphics[height=2cm]{CycleGAN_graph2}}
\caption{\label{fig:cyclegan} (a) CycleGAN consists of two mappings, $G_{X}$ and $G_{Y}$ and a corresponding discriminators $D_{X}$ and $D_{Y}$. (b) Cycle Consistency Loss measures the L1 distance between a real sample from one image domain and its encoded-decoded version.}
\end{figure}
