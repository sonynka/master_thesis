...
Finally, the chapter introduces several features for image retrieval, from low-level features and features produced by a convolutional neural network, that can be used to retrieve similar images to both original and synthesized images.
